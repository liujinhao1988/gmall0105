...
public class SearchController {
    ...
    public String list(PmsSearchParam pmsSearchParam, ModelMap modelMap){//三级分类id，关键字,PmsSkuAttrValue 参数可能有很多种，为此新建一个类
        ...
        //如果valueIds参数部位空，当前请求中包含的属性参数，每一个属性参数都会生成一个面包谑
        if(delValueIds!=null){
            //面包屑//在urlParam中将delValueId拿掉
            //pmsSearchParam
            //delValueIds
